...
public class MarkAttendanceFaculty extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dbHelper = new DatabaseHelper(MarkAttendanceFaculty.this);
        inputValidatorHelper = new InputValidatorHelper();

        subject = dbHelper.getAllAssignedSubjectsSpinner(((ApplicationContext) MarkAttendanceFaculty.this.getApplicationContext()).getFacultyBean().getFacultyId());
    ...
    private void performInsert() {
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                boolean res = dbHelper.insertAttendance(students, division, subjectId, ((ApplicationContext) MarkAttendanceFaculty.this.getApplicationContext()).getFacultyBean().getFacultyId(), date, day, month, yearInt);
                if(!res) {
                    Toast.makeText(MarkAttendanceFaculty.this, "Some error has occured!!!", Toast.LENGTH_LONG).show();
                } else {
                    Toast.makeText(MarkAttendanceFaculty.this, "Attendance Marked Successfully!!!", Toast.LENGTH_LONG).show();
                    setInitialValues();
