...
public class ViewAttendance extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dbHelper = new DatabaseHelper(ViewAttendance.this);
    ...
    private void setInitialValues() {
        ...
        lstFaculty = new ArrayList<>();
        lstFaculty.add("Select");
        lstFaculty.addAll(faculty.getValues());
        ...
        int assignedFacultyId = dbHelper.isSubjectAssigned(subjectId);
        if(assignedFacultyId != -1) {
            facultyId = assignedFacultyId;
            for(int i=0;i<faculty.getIds().size();i++) {
                if(faculty.getIds().get(i) == assignedFacultyId) {
                    txtFaculty.setText(lstFaculty.get(i + 1));
                }
            }
        } else {
            facultyId = -1;
            txtFaculty.setText(lstFaculty.get(0));
        }
...
//                    facultyId = -1;
//                } else {
//                    facultyId = faculty.getIds().get(position - 1);
//                }
//            }
//        });
    }
